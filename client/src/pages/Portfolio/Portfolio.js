  ...
  useEffect(() => {
    ...
    return (
        ...
        <div className="row justify-content-center row-margin">
            ...
            <ProjectCard imgsrc='./images/nwconnect.jpg' project="NWLife Connect" summary="The NWLife Connect app is being utilized by a local faith community in the midst of a pandemic as a means to connect with individuals in a safe way. Users fill out a form that has various sections relating to their needs and their data is saved for follow up contact." githublink="https://github.com/VinAVarghese/NWLifeConnect" deployedlink="https://nwlife-connect.herokuapp.com/" />
            <ProjectCard imgsrc='./images/mixme.png' project="MixMe" summary="An app for the everyday and aspiring mixologist. Using JavaScript and API consumption, my team created an app that helps users search, make, and even find unique mixed drinks locally! This version also includes a beta version of a quiz game." githublink="https://github.com/VinAVarghese/ProjectMixMe" deployedlink="https://vinavarghese.github.io/ProjectMixMe/" />
